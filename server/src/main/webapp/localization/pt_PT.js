...
document.localization ['pt_PT'] = {
    ...
    'question.device.reset': 'Solicitar restauração de fábrica do dispositivo "${deviceNumber}"? O aparelho apagará todos os dados na próxima sincronização.',
    'success.device.reset.requested': 'Reset solicitado. O dispositivo fará restauração de fábrica na próxima sincronização.',
