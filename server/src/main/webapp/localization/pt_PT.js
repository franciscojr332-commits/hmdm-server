...
document.localization ['pt_PT'] = {
    ...
    'button.group.action': 'Ação em grupo',
    ...
    'button.device.reset': 'Restaurar dispositivo de fábrica',
    'question.device.reset': 'Solicitar restauração de fábrica do dispositivo "${deviceNumber}"? O comando será enviado via push e o aparelho apagará todos os dados em instantes.',
    'success.device.reset.requested': 'Comando enviado via push. O dispositivo receberá e fará restauração de fábrica em tempo real.',
    'error.device.reset': 'Falha ao solicitar reset do dispositivo.',
    'form.device.reset.select.hint': 'Selecione o dispositivo para enviar o comando de restauração de fábrica. O comando será enviado via push.',
    'form.device.reset.select.device': 'Dispositivo',
    'form.device.reset.select.placeholder': '— Selecionar dispositivo —',
    'form.device.reset.no.devices': 'Nenhum dispositivo na lista atual. Faça uma busca primeiro.',
    ...
    'form.configuration.settings.mdm.block.airplane.mode': 'Bloquear modo avião',
    'form.configuration.settings.mdm.block.power.off.window': 'Impedir desligar entre',
    'form.configuration.settings.mdm.block.power.off.from': 'HH:mm (ex: 07:00)',
    'form.configuration.settings.mdm.block.power.off.to': 'HH:mm (ex: 18:00)',
    'form.configuration.settings.mdm.block.power.off.to.label': 'e',
    'form.configuration.settings.mdm.block.power.off.hint': 'Fora desse horário o aparelho pode ser desligado. Deixe em branco para permitir desligar sempre. Formato HH:mm.',
    ...
    'form.configuration.settings.design.background.image.hint': 'Use JPEG ou PNG; recomendado até 2 MB e 1920×1080. A URL deve ser acessível pelos dispositivos (mesmo Base URL do servidor). Salve a configuração e sincronize o dispositivo para a imagem aparecer. Sem internet o launcher pode perder a imagem (ela é carregada pela URL); defina também uma cor de fundo para fallback offline.',
