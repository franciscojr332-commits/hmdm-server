...
document.localization ['it_IT'] = {
	...
	'form.configuration.file.from.server': 'Oppure seleziona dal server (file in /usr/local/tomcat/work/files/)',
	'form.configuration.file.list.server': 'Elenca file del server',
	'form.configuration.file.loading': 'Caricamento...',
	'form.configuration.file.size': 'Dimensione',
	'form.configuration.file.use.server': 'Usa',
	'form.configuration.file.no.server.files': 'Nessun file trovato nella directory del server.',
	...
	'manual.title': 'Manuale di installazione di Mikitos MDM',
	'manual.domain': 'Nome dominio',
	'manual.domain.placeholder': 'Nome dominio della tua istanza Mikitos MDM',
	...
	'manual.option.0': 'Imposta una nuova istanza di Mikitos MDM',
	'manual.option.1': 'Aggiorna Mikitos MDM Community',
	'manual.option.2': 'Installa i plugin Mikitos Remote e URL Filtering',
	'manual.option.3': 'Imposta una nuova istanza di Mikitos Remote',
