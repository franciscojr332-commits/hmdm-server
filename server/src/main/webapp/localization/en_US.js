...
document.localization ['en_US'] = {
    ...
    'question.device.reset': 'Request factory reset for device "${deviceNumber}"? The device will wipe all data on next sync.',
    'success.device.reset.requested': 'Reset requested. The device will perform factory reset on next sync.',
