...
document.localization ['en_US'] = {
    ...
    'button.device.reset': 'Factory reset device',
    'question.device.reset': 'Request factory reset for device "${deviceNumber}"? The command will be sent via push and the device will wipe all data shortly.',
    'success.device.reset.requested': 'Command sent via push. The device will receive it and perform factory reset in real time.',
    'error.device.reset': 'Failed to request device reset.',
    'form.device.reset.select.hint': 'Select the device to send the factory reset command. The command will be sent via push.',
    'form.device.reset.select.device': 'Device',
    'form.device.reset.select.placeholder': '— Select device —',
    'form.device.reset.no.devices': 'No devices in the current list. Run a search first.',
    ...
    'form.configuration.settings.mdm.block.airplane.mode': 'Block airplane mode',
    'form.configuration.settings.mdm.block.power.off.window': 'Block power off between',
    'form.configuration.settings.mdm.block.power.off.from': 'HH:mm (e.g. 07:00)',
    'form.configuration.settings.mdm.block.power.off.to': 'HH:mm (e.g. 18:00)',
    'form.configuration.settings.mdm.block.power.off.to.label': 'and',
    'form.configuration.settings.mdm.block.power.off.hint': 'Outside this time window the device can be turned off. Leave blank to always allow power off. Format HH:mm.',
    ...
    'form.configuration.settings.design.background.image.hint': 'Use JPEG or PNG; recommended up to 2 MB and 1920×1080. The URL must be reachable from devices (same Base URL as the server). Save configuration and sync the device for the image to appear. When the device loses internet the launcher may lose the background image (it is loaded from the URL); set a background color as well for offline fallback.',
    ...
    'form.configuration.file.from.server': 'Or select from server (files in /usr/local/tomcat/work/files/)',
    'form.configuration.file.list.server': 'List server files',
    'form.configuration.file.loading': 'Loading...',
    'form.configuration.file.size': 'Size',
    'form.configuration.file.use.server': 'Use',
    'form.configuration.file.no.server.files': 'No files found in server directory.',
